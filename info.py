...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002833936259').split()]  # For Multiple Id Use One Space Between Each.
...
reqst_channel = environ.get('REQST_CHANNEL', '-1003022143069')
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002982934807')
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None

# This Channel Is For /batch command file store.
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1003071824692')).split()]  # For Multiple Id Use One Space Between Each.
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002921674541').split()]  # For Multiple Id Use One Space Between Each.


# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://melodysotto4_db_user:BCUKIKDEAqFEzeCj@cluster0.trrt89o.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "Mazhavil_sandeep1_bot")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'mazhavilcollection')
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+AEcrxKKBSQwwMWVl')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+S6lev2D8sEo4YjA1') # Support Chat Link Without https:// or @
